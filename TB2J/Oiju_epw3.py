...
from HamiltonIO.epw.epwparser import Epmat, EpmatOneMode
...
def gen_exchange_Oiju_epw(path,
    ...
    if colinear:
        ...
        exchange.set_epw(Ru, imode=imode, epmat_up=epw_up, epmat_dn=epw_dn)
...
if __name__ == '__main__':
    ...
    for imode in [0, 3, 4, 5, 6, 7, 8]:
        gen_exchange_Oiju_epw(
            ...
            # prefix_dn='wannier90.dn',
            prefix_up="up/SrMnO3",
            prefix_dn="down/SrMnO3",
            #prefix_SOC='wannier90',
            # epw_path="/home/hexu/projects/SrMnO3/spinphon_data/epw555_NC",
            epw_path="down",
            epw_prefix='down/SrMnO3',
            imode=imode,
            Ru=(0, 0, 0),
            Rcut=8,
            efermi=11.26,
