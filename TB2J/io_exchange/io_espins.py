...
def write_espins_input(cls, fname):
    ...
    with open(fname, "w") as myfile:
        ...
        myfile.write("tem_start          =   0.01\n")
        myfile.write("tem_end            =   30\n")
        myfile.write("tems_num           =   56\n")
        ...
        myfile.write("steps_warmup      =       400000\n")
        myfile.write("steps_mc          =       400000\n")
        myfile.write("steps_measure     =           2\n\n")

        myfile.write("initial_sconfig   =        rand\n")
        myfile.write("mcarlo_mode       =       random\n\n")

        myfile.write("supercell_size    =      40     40     1\n\n")
