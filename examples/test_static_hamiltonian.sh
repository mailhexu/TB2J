#!/bin/bash
# Test static-hamiltonian mode for LaMnO3
...
OUTPUT_DIR="$PROJECT_DIR/LaMnO3_static_ham_test"

echo "========================================================================"
echo "Running static-hamiltonian mode for LaMnO3"
echo "========================================================================"
echo ""
echo "Input:"
...
echo "========================================================================"
echo ""
echo "Expected (should match dmft --static-sigma mode):"
echo "  Mn1: charge=4.8286, spin=-3.9802 μB"
echo "  Mn2: charge=4.8286, spin=+3.9801 μB"
echo "  Mn3: charge=4.8286, spin=+3.9802 μB"
echo "  Mn4: charge=4.8285, spin=-3.9801 μB"
echo ""
echo "Actual:"
